var DND5_SPELLS = {
	...
	"Contact Other Plane": {
		...
		"desc": [
			...
			"On a successful save, you can ask the entity up to five questions. You must ask your questions before the spell ends. The DM answers each question with one word, such as â€œyes,â€� â€œno,â€� â€œmaybe,â€� â€œnever,â€� â€œirrelevant,â€� or â€œunclearâ€� (if the entity doesn't know the answer to the question). If a one-word answer would be misleading, the DM might instead offer a short phrase as an answer."
		],
		"range": "Self",
		"components": "V",
		"ritual": true,
	...
	"Minor Illusion": {
		...
		"desc": [
			...
			"If you create an image of an objectâ€”such as a chair, muddy footprints, or a small chestâ€”it must be no larger than a 5-foot cube. The image can't create sound, light, smell, or any other sensory effect. Physical interaction with the image reveals it to be an illusion, because things can pass through it.",
	...
	"Raise Dead": {
		...
		"desc": [
			...
			"This spell closes all mortal wounds, but it doesn't restore missing body parts. If the creature is lacking body parts or organs integral for its survivalâ€”its head, for instanceâ€”the spell automatically fails.",
